...
@foreach ($files as $file)
  <tr>
    ...
    <td>
      ...
      @endif
        <a href="/upload/file?path={{$file['fullPath']}}&name={{$file['name']}}" >
...
@section('scripts')
  <script>
    ...
    function download_file(path) {
      ...
      $("#download-file-name1").html(path);
      $("#download-file-name2").val(path);
      $("#modal-file-download").modal("show");
